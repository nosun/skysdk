...
public class DevDataAirPurifier extends DevData implements IMCUCoder<JSONArray>{
	//控制量
...
//	private String sleepMode;
	...
	public static final HashMap<MODE, String> MODE_MAP = new HashMap<DevDataAirPurifier.MODE, String>(){{
...
//	public static final String KEY_SLEEPMODE = "sl";
	...
	public DevDataAirPurifier() {
		super();
	}
	public DevDataAirPurifier(DevData data) {
		super(data);
	}
